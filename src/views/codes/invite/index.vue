...
export default {
  ...
  methods: {
    ...
    handleLink (index, column) {
      this.$router.push({name: 'invite/channel', params: {'parent_id': column.id}})
    },
    // 删除事件
