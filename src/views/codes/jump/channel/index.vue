            ...
            <el-col style="white-space: nowrap;">
                <el-form :model="search" :rules="rulesSearch" ref="searchForm" :inline="true">
                    ...
                    <el-form-item prop="content">
                        <el-input v-model="search.content" clearable placeholder="备注"></el-input>
                    </el-form-item>
...
import edit from '@/views/codes/jump/channel/edit'
      ...
      tableData: [
        {
          ...
          uid: '2',
          parent_id: '1',
          url: 'http://www.ljt2.cc/jumpurl/j/1/jumpurl/j/1/jumpurl/j/1/jumpurl/j/1/jumpurl/j/1/',
          status: 0,
          is_delete: 0,
          total_limit: 9999,
          total: 1089,
